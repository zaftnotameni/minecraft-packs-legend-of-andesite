...
const basicCasing = 'create:andesite_casing';
const basicCasingS = 'kubejs:basic_casing_shaft';
const basicCasingC = 'kubejs:basic_casing_cog';
const basicCasingE = 'kubejs:basic_casing_electron';
const basicCasingSC = 'kubejs:basic_casing_shaft_cog';
const basicCasingSE = 'kubejs:basic_casing_shaft_electron';
const basicCasingCE = 'kubejs:basic_casing_cog_electron';
const basicCasingSCE = 'kubejs:basic_casing_shaft_cog_electron';
const fluidCasing = 'create:copper_casing';
const fluidCasingS = 'kubejs:fluid_casing_shaft';
const fluidCasingC = 'kubejs:fluid_casing_cog';
const fluidCasingE = 'kubejs:fluid_casing_electron';
const fluidCasingSC = 'kubejs:fluid_casing_shaft_cog';
const fluidCasingSE = 'kubejs:fluid_casing_shaft_electron';
const fluidCasingCE = 'kubejs:fluid_casing_cog_electron';
const fluidCasingSCE = 'kubejs:fluid_casing_shaft_cog_electron';
const advancedCasing = 'create:brass_casing';
const advancedCasingS = 'kubejs:advanced_casing_shaft';
const advancedCasingC = 'kubejs:advanced_casing_cog';
const advancedCasingE = 'kubejs:advanced_casing_electron';
const advancedCasingSC = 'kubejs:advanced_casing_shaft_cog';
const advancedCasingSE = 'kubejs:advanced_casing_shaft_electron';
const advancedCasingCE = 'kubejs:advanced_casing_cog_electron';
const advancedCasingSCE = 'kubejs:advanced_casing_shaft_cog_electron';
